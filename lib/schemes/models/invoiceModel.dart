...
class SchemeInvoiceModel {
  ...
  bool? isPosInvoice;
  bool? isSaleReturn;
  List<SchemeInvoiceDetailModel> invoiceDetails;
  List<SchemeInvoiceDiscountDto> invoiceDiscounts;
  ...
  SchemeInvoiceModel copyWith({
    ...
    return SchemeInvoiceModel(
      ...
      invoiceDiscounts: invoiceDiscounts ?? this.invoiceDiscounts,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'invoiceDetails': invoiceDetails.map((x) => x.toMap()).toList(),
      'invoiceDiscounts': invoiceDiscounts.map((x) => x.toMap()).toList(),
      'paymentDetails': paymentDetails?.map((x) => x.toMap()).toList(),
    };
  }

  factory SchemeInvoiceModel.fromMap(Map<String, dynamic> map) {
    return SchemeInvoiceModel(
      id: map['id']?.toInt(),
  ...
  bool operator ==(Object other) {
    ...
    return other is SchemeInvoiceModel &&
        other.id == id &&
        ...
        listEquals(other.invoiceDetails, invoiceDetails) &&
        listEquals(other.invoiceDiscounts, invoiceDiscounts) &&
        listEquals(other.paymentDetails, paymentDetails);
  }
