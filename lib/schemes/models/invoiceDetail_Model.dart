...
class InvoiceDetailModel extends BaseModel<int> {
  @override
  int? id;
  @override
  String? companySlug;
  ...
  factory InvoiceDetailModel.fromMap(Map<String, dynamic> map, {String? slug}) {
    return InvoiceDetailModel(
        id: map['id']?.toInt(),
        companySlug: slug,
  ...
  BaseModel fromJson(Map<String, dynamic> json, {String? slug}) {
    return InvoiceDetailModel.fromMap(json, slug: slug);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is InvoiceDetailModel &&
        other.id == id &&
  ...
  List<InvoiceDetailModel> FromJson(String str) => List<InvoiceDetailModel>.from(json.decode(str).map((x) => InvoiceDetailModel().fromJson(x)));

  String ToJson(List<InvoiceDetailModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
}
