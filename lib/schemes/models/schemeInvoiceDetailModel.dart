...
import 'invoiceDetailTaxModel.dart';
import 'invoiceDiscountModel.dart';

class SchemeInvoiceDetailModel {
  int? id;
  String? companySlug;
  int? saleInvoiceId;
  int? productId;
  ...
  SchemeInvoiceDetailModel copyWith({
    int? id,
    String? companySlug,
    int? saleInvoiceId,
    int? productId,
    ...
    return SchemeInvoiceDetailModel(
      id: id ?? this.id,
  ...
  factory SchemeInvoiceDetailModel.fromMap(Map<String, dynamic> map) {
    return SchemeInvoiceDetailModel(
      id: map['id']?.toInt(),
      ...
      discounts: map['discounts'] != null ? List<InvoiceDetailDiscountModel>.from(map['discounts']?.map((x) => InvoiceDetailDiscountModel.fromMap(x))) : null,
  ...
  factory SchemeInvoiceDetailModel.fromJson(String source) => SchemeInvoiceDetailModel.fromMap(json.decode(source));
  ...
  bool operator ==(Object other) {
    ...
    return other is SchemeInvoiceDetailModel &&
        other.id == id &&
